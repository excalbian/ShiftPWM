...
#define SHIFTPWM_LED_RBG // change byte ordering to RBG from RGB
...
unsigned int numRegisters = 2; // Remeber this is counting 8-bit registers I think.
  ...
  if(Serial.available()){
    if(Serial.peek() == 'l'){
      ...
      case 9:
        ...
        break;
      case 10:
        Serial.println("Configure a specific color for all LED's");
        Serial.setTimeout(3000); // Timeout is 5 seconds
        Serial.print("Enter the RED color value (0-255):");
        int r; int g; int b;
        r = Serial.parseInt();
        Serial.println(r);
        Serial.print("Enter the GREEN color value (0-255):");
        g = Serial.parseInt();
        Serial.println(g);
        Serial.print("Enter the BLUE color value (0-255):");
        b = Serial.parseInt();
        Serial.println(b);
        ...
        break;
      case 11:
        ShiftPWM.SetAllRGB(254,0,0);
        break;
      case 12:
        ShiftPWM.PrintBuffer();
        break;        
      default:
...
void printInstructions(void){
  ...
  Serial.println("");
  Serial.println(" 10. Set all LED's to a specified color value");
  Serial.println(" 11. TBD :)");
